...
public:
    ...
    void setupUi(QDialog *teamDialog)
    {
        ...
        buttonBox->setGeometry(QRect(280, 159, 211, 81));
        ...
        worknameEdit->setGeometry(QRect(80, 30, 101, 31));
        label = new QLabel(teamDialog);
        label->setObjectName("label");
        label->setGeometry(QRect(20, 30, 53, 31));
        schoolnamelineEdit = new QLineEdit(teamDialog);
        schoolnamelineEdit->setObjectName("schoolnamelineEdit");
        schoolnamelineEdit->setGeometry(QRect(80, 80, 101, 31));
        label_2 = new QLabel(teamDialog);
        label_2->setObjectName("label_2");
        label_2->setGeometry(QRect(20, 80, 53, 31));
